...
export const GoalStructure = () => {
    ...
    const [showEditGoalCollection, setShowEditGoalCollection] =
        useState<boolean>(false)
    const [editGoalCollection, setEditGoalCollection] =
    ...
    const onRankEnd = (params: any) => {
        if (
            !params.destination ||
            params.sourceKey === params.destination.afterKey
        )
            return
        navigation(
    ...
    const renderActiveSpotlight = () => {
        const spotlights = [
            <Spotlight
                ...
                key="project"
            >
                Thanks for using Benefit/Cost, a brief introduction of the
                project pages will now follow.
            </Spotlight>,
            <Spotlight
                actions={[
                    {
                ...
                key="goal-structure"
            >
                View and administrate all the goal collections, set cost and
                time per epic and create goals. A goal structure is a layer/tier
                of goals, at the bottom you can find epics, above that you might
                find project goals, followed by company goals and so on.
            </Spotlight>,
            <Spotlight
                actions={[
                    {
                ...
                key="estimation"
            >
                The estimation tab is used for assigning benefit points to each
                task.
            </Spotlight>,
            <Spotlight
                actions={[
                ...
                key="analysis"
            >
                View an analysis of graphs and a table over all the entered
                values and sort by the preferred metric. Graphs like burndown
            ...
            >
                Use this button to create new goal collections such as a
                collection for project goals.
            </Spotlight>,
            <Spotlight
                actions={[
                    {
                ...
                key="set-costs-time"
            >
                Create new goals by selecting a tier above tier 1,
                then you can create, manage, delete and set values.
            </Spotlight>,
            <Spotlight
                actions={[
                    {
                ...
                key="set-costs-time"
            >
                By selecting goal Tier 1 you can set the cost and time for each
                epic.
            </Spotlight>,
            <Spotlight
                actions={[
            ...
            >
                More information about how to use Benefit/Cost can be found on
            ...
            <Spotlight
                ...
                key="settings"
            >
                The settings for what issue type to target and what fields can
                be changed at any time in the settings.
            </Spotlight>,
            <Spotlight
                actions={[
                    { onClick: () => end(), text: 'OK' },
            ...
            >
                You can restart this onboarding at any time by pressing this
                help icon.
            </Spotlight>,
        ]
        ...
        <>
            ...
            {selectedOption && (
                <GoalTable
                    ...
                    isHighestGoalTier={
                        items.length > 0 &&
                        selectedOption.value.id === items[0].id
                    }
