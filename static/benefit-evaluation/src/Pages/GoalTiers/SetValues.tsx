            ...
            <Modal onClose={() => onClose(false)}>
                <ModalHeader>
                    ...
                    <Tooltip
                        ...
                        content='You can set value estimates of goals by either giving relative weights ("goal points") or monetary values.'
                    >
                        <Box
                            style={{
                                cursor: 'pointer',
                ...
                <ModalBody>
                    <Stack space="space.100">
                        <Inline alignBlock="start" space="space.400">
                            <div>
                                ...
                                <RadioGroup
                                    ...
                                    options={[
                                        ...
                                        {
                                            name: 'monetary',
                                            value: `${balancedPointsEnum.MONETARY}`,
                            ...
                            <div>
                                <Label htmlFor="basic-textfield">Postfix</Label>
                                <TextField
                                    name={`postfix`}
                                ...
                                {method === `${balancedPointsEnum.MONETARY}` ? (
                                    <HelperMessage>
                                        {`Maximum ${MAX_POSTFIX_LENGTH} characters`}
                                    </HelperMessage>
                                ) : (
                                    <HelperMessage>
