        ...
        plugins: {
            ...
            tooltip: {
                callbacks: {
                    label: (context: any) => {
                        const dataPoint =
                            chartData.datasets[context.datasetIndex].data[
                                context.dataIndex
                            ]
                        const label =
                            chartData.datasets[context.datasetIndex].label
    ...
    return (
        <div style={{ position: 'relative' }}>
            ...
            <Tooltip
                ...
                content="The scattered epics to show the general spread of epics."
            >
                <Box
                    style={{
                        cursor: 'pointer',
