...
const RealizedBenefit = ({
    ...
    useEffect(() => {
        ...
        setLabels(labels)
        if (labels.length > 0) {
            datasetBenefit[datasetBenefit.length - 1] = isMonetary
                ? totalBenefit
                : 100
            datasetCost[datasetCost.length - 1] = isMonetary ? totalCosts : 100
        }
    ...
    const CustomLegend = () => (
        ...
        >
            ...
            A5.333333333333333,5.333333333333333,0,1,1,10.666666666666666,16"
                ...
                <span style={{ color: '#2ea34d', cursor: 'default' }}>
                    Benefit
                </span>
            </div>
            <div
            ...
            A5.333333333333333,5.333333333333333,0,1,1,10.666666666666666,16"
                ...
                <span style={{ color: '#ff6384', cursor: 'default' }}>
                    Cost
                </span>
            </div>
        </div>
    ...
    return (
        <div style={{ position: 'relative' }}>
            <PageHeader>Realized: Benefit & Costs</PageHeader>
            <Tooltip
                component={InlineDialog}
                content="The realized benefit and cost accumulated by a product of time."
            >
                <Box
                    style={{
                        cursor: 'pointer',
...
export default RealizedBenefit
