            ...
            tooltip: {
                ...
                callbacks: {
                    label: (context: any) => {
                        ...
                        const dataPoint =
                            chartData[context.datasetIndex].data[
                                context.dataIndex
                            ]
    ...
    return (
        <div style={{ position: 'relative' }}>
            ...
            <Tooltip
                ...
                content="View the estimated benefit and cost by the cumulative order of epics completed. Along with the trend from a regression analysis."
            >
                <Box
                    style={{
                        cursor: 'pointer',
