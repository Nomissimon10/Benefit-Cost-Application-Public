...
export const PieChartBenefit = ({ items, benefit }: Props) => {
    ...
    useEffect(() => {
        ...
        const datasetBenefit: any = items.map(
            (item) => benefit ? item!.balancedPoints!.value : item!.issueCost!.balanced_points * 100
        )
    ...
    return (
        <div style={{ position: 'relative' }}>
            ...
            <Tooltip
                ...
                content={`The ${benefit ? 'benefits' : 'costs'} piechart shows the share each epic takes of the ${benefit ? 'benefit' : 'cost'} points.`}
            >
                <Box
                    style={{
                        cursor: 'pointer',
            ...
            >
                <Pie
                    ...
                    data={{
                        ...
                        datasets: [
                            {
                                label: benefit ? 'Benefit Points' : 'Cost Points',
                                data: chartData,
                                backgroundColor: [
                                    'rgba(255, 99, 132, 0.8)',
                                    'rgba(54, 162, 235, 0.8)',
